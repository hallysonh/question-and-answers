...
const (
	...
	QuestionService_ListQuestions_FullMethodName   = "/question.QuestionService/ListQuestions"
...
type QuestionServiceClient interface {
	GetQuestionByID(ctx context.Context, in *QuestionRequest, opts ...grpc.CallOption) (*Question, error)
	ListQuestions(ctx context.Context, in *ListQuestionRequest, opts ...grpc.CallOption) (*QuestionList, error)
	...
	DeleteQuestion(ctx context.Context, in *DeleteQuestionRequest, opts ...grpc.CallOption) (*Question, error)
}
...
func (c *questionServiceClient) GetQuestionByID(ctx context.Context, in *QuestionRequest, opts ...grpc.CallOption) (*Question, error) {
	out := new(Question)
...
func (c *questionServiceClient) ListQuestions(ctx context.Context, in *ListQuestionRequest, opts ...grpc.CallOption) (*QuestionList, error) {
	out := new(QuestionList)
	err := c.cc.Invoke(ctx, QuestionService_ListQuestions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *questionServiceClient) DeleteQuestion(ctx context.Context, in *DeleteQuestionRequest, opts ...grpc.CallOption) (*Question, error) {
	out := new(Question)
...
type QuestionServiceServer interface {
	GetQuestionByID(context.Context, *QuestionRequest) (*Question, error)
	ListQuestions(context.Context, *ListQuestionRequest) (*QuestionList, error)
	...
	DeleteQuestion(context.Context, *DeleteQuestionRequest) (*Question, error)
...
func (UnimplementedQuestionServiceServer) GetQuestionByID(context.Context, *QuestionRequest) (*Question, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetQuestionByID not implemented")
}
func (UnimplementedQuestionServiceServer) ListQuestions(context.Context, *ListQuestionRequest) (*QuestionList, error) {
...
func (UnimplementedQuestionServiceServer) DeleteQuestion(context.Context, *DeleteQuestionRequest) (*Question, error) {
...
func _QuestionService_GetQuestionByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QuestionServiceServer).GetQuestionByID(ctx, req.(*QuestionRequest))
	}
...
func _QuestionService_ListQuestions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QuestionServiceServer).ListQuestions(ctx, req.(*ListQuestionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
